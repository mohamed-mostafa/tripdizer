		...
		if (err) {
			...
			connection.beginTransaction(function (err) {
				...
				if (err) {
					...
					var updateQuery = `UPDATE iternary SET EN_Name = '${itinerary.en_name}', EN_Description = '${itinerary.en_description}', AR_Name = '${itinerary.ar_name}', AR_Description = '${itinerary.ar_description}', Daily_Spendings = '${itinerary.dailySpendings}', Stars = '${itinerary.stars}' WHERE Id = '${itinerary.id}';`;
