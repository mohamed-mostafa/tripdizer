...
tripdizerApplication.controller("ReservationController", ['$rootScope', '$scope', '$http', '$location', function($rootScope, $scope, $http, $location) {
	...
	$scope.activitiesTitle = "Activities: 0%";
	$scope.shoppingTitle = "Shopping: 0%";
	$scope.beachesTitle = "Beaches: 0%";
	$scope.nightlifeTitle = "Nighlife: 0%";
	$scope.natureTitle = "Natrue: 0%";
	$scope.historyTitle = "History: 0%";
